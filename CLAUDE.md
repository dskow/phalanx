# Castrum — project guidelines

Castrum is a public portfolio project. README and docs are public-facing — they describe prior security and agentic work neutrally without naming former employers or products.
...
```bash
docker compose up castrum-run     # the studio against target/
...
- Side effects (filesystem writes, shell, network) go through `castrum.guardrails`. No agent module imports `subprocess`, `os.system`, or `socket`.
